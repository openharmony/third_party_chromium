...
# following args will passed here by command line from ohos src build
...
./third_party/depot_tools/autoninja -C out/Default/ -j$buildcount libnweb_adapter libweb_engine web_render libnweb_render
